...
public class ExpressAdapter extends FirestoreRecyclerAdapter<ExpressModel, ExpressAdapter.Holder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull Holder holder, int i, @NonNull ExpressModel expressModel) {
        holder.mNameTxt.setText(expressModel.getA_name());
        holder.mDormitoryTxt.setText(expressModel.getA_dormitory());
        holder.mRoomTxt.setText(expressModel.getA_room());
        holder.mDoneTimeTxt.setText(expressModel.getA_waktu_selesai());

        //orderHolder.mjenis.setText(model.getA_jenis());
        if (expressModel.getA_price2() != null) {
            Log.d("tidak ", "null");
            int priceInt = Integer.valueOf(expressModel.getA_price2());
            int diskonInt = Integer.valueOf(expressModel.getA_diskon());
        ...
        String string1 = "1";
        if (expressModel.getH_accepted2().equals(string1)) {
        ...
        if (expressModel.getH_on_proses2().equals(string1)) {
        ...
        if (expressModel.getH_done2().equals(string1)) {
