package com.tiunida.courierapp.FragmentKilat.Model;

public class KilatModel {
    String a_time, a_waktu_selesai;

    String h_accepted2, h_delivered2, h_done2, h_on_proses2, h_paid2, a_price2, a_diskon, a_jenis;
    String a_name, a_dormitory, a_room, a_phone_number, a_status, a_gender;

    public KilatModel(){

    }

    public KilatModel(String a_time, String a_waktu_selesai, String h_accepted2, String h_delivered2, String h_done2, String h_on_proses2, String h_paid2, String a_price2, String a_diskon, String a_jenis, String a_name, String a_dormitory, String a_room, String a_phone_number, String a_status, String a_gender) {
        this.a_time = a_time;
