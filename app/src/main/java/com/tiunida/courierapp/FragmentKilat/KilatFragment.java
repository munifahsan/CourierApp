package com.tiunida.courierapp.FragmentKilat;
...
import com.tiunida.courierapp.FragmentKilat.Adapter.KilatAdapter;
...
public class KilatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragment = inflater.inflate(R.layout.fragment_kilat, container, false);
        ...
        FirestoreRecyclerOptions<KilatModel> options = new FirestoreRecyclerOptions.Builder<KilatModel>()
                .setQuery(query, KilatModel.class)
                .build();

        adapter = new KilatAdapter(options);
        ...
        adapter.setOnItemClickListener(new KilatAdapter.OnItemClickListener() {
            @Override
...
//                .whereEqualTo("h_delivered2", "")
    ...
    private void getAllData() {
        adapter.stopListening();
        Log.d("test", "sip");
        query = ordersRef.whereEqualTo("a_jenis", "Kilat").orderBy("a_uniq_id", Query.Direction.DESCENDING);
